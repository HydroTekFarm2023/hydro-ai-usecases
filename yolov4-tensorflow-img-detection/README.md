...
* Run the detect_api.py program and use the following request to run the detection.

* curl "http://127.0.0.1:5000/predict?bucketName=shivam-hydrotek-test&imageName=pest.jpg&customerDB=hydrotekaidb&plantType=Lettuce&apiType=dev"

## API Documentation

* bucketName - Name of Google Cloud Storage Bucket  
* imageName - Name of Image present in the GCP Storage Bucket  
* customerDB - MongoDB Atlas DB Name  
* plantType - Name of the Plant(eg: Lettuce, Strawberry)  
* apiType - Type of API  
